package com.jp.jchannels.server;
...
import com.jp.jchannels.server.http.HttpServlet;
import com.jp.jchannels.server.ws.WSTopic;
import com.jp.jchannels.server.ws.broadcast.BroadcastSocket;
import com.jp.jchannels.server.ws.broadcast.Broadcaster;
...
public class WebServerBuilder {
    ...
    public WebServerBuilder withBroadcastHandler(String path, List<WSTopic> topics, 
                                                 MessageQueue<BroadcastMessage<String>> gameMessageQueue,
    ...
    public WebServerBuilder withServletHandler(String path, IAuthorizer authorizer, 
                                               String scope, MessageActor<HttpRequest, HttpResponse> messageActor) {
    ...
    public WebServerBuilder withServletHandler(String path, MessageActor<HttpRequest, HttpResponse> messageActor) {
